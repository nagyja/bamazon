...
function selector() {
    ...
    inquirer.prompt([
        ...
        var id = parseInt(a.productId); // make product ID into an int
        ...
        if(requestedQty > stockQty) {
            ...
            con.query("UPDATE products SET ? WHERE ?", [
                ...
                console.log("");
                console.log("You purchased " + requestedQty + " " + prodArr[id-1][1]);
                console.log("You spent: $" + total + " dollar(s)");
            });
